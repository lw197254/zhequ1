...
//        trackCircle.path     = [UIBezierPath bezierPathWithRoundedRect:trackCircle.bounds cornerRadius:circleFrameSide / 2].CGPath;
        ...
        // 添加路径 到path
        [linepath moveToPoint:CGPointMake(0, trackLabel.position.y-10)];
        [linepath addLineToPoint:CGPointMake(0, trackLabel.position.y)];
        // 将path绘制出来
        trackCircle.path = linepath.CGPath;
        trackCircle.strokeColor = [self trackCircleColor:trackCircle];
        
        trackCircle.lineWidth = 0.5;
