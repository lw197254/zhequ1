//
//  CarTableViewHeaderFooterView.m
//  chechengwang
//
...
@implementation CarTableViewHeaderFooterView
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self = [super initWithFrame:frame]){
        ...
        [headlineView setBackgroundColor:BlackColorF1F1F1];
        ...
        [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(headlineView.mas_bottom);
