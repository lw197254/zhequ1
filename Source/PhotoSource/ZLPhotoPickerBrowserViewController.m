...
@interface ZLPhotoPickerBrowserViewController () <UIScrollViewDelegate,ZLPhotoPickerPhotoScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIActionSheetDelegate,UIGestureRecognizerDelegate>
...
-(UIImageView*)downloadImage{
    if (!_downloadImage) {
        ...
        self.downloadImage.image = [UIImage imageNamed:@"icdownload"];
