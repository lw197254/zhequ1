...
//        [self addGestureRecognizer:longGesture];
        ...
        singleGesture.numberOfTapsRequired = 1; // 单击
...
-(UILabel *)carLabel{
    if (!_carLabel) {
        ...
        _carLabel.contentMode = UIViewContentModeCenter;
        
        [self.carLabel mas_updateConstraints:^(MASConstraintMaker *make) {
