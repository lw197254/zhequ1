...
//    self.titleImageView.frame = self.frame;
...
- (void) buildUI {
    ...
    if (self.titleImageView == nil) {
        UIImageView *titleImageView = self.titleImage != nil ? [[UIImageView alloc] initWithImage:self.titleImage] : [[UIImageView alloc] initWithFrame:self.contentView.bounds];
    ...
    if(self.button == nil){
        self.view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kwidth, 70)];
        [self.view  setBackgroundColor:BlackColorF8F8F8];
        
        [pageView addSubview:self.view];
        
        self.button = [[UIButton alloc] init];
        
        
        [self.view addSubview:self.button];
        [self.view setTopLine];
    }
