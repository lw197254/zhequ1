...
typedef NS_ENUM(NSInteger, PYHistoryPosition)  { // 热门搜索标签风格
       PYHistoryPositionBottom, // 历史在上面
      PYHistoryPositionTop    // 历史在下面
...
@interface PYSearchViewController : ParentViewController
...
///搜索历史放在顶部还是底部
@property (nonatomic, assign) PYHistoryPosition historyPosition;
