...
//    [_s5 setFrame:CGRectMake(startX, 0, width, height)];
    ...
    [_s1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.top.equalTo(self);
    }];
    
    [_s2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(_s1);
        make.left.equalTo(_s1.mas_right).offset(space);
    }];
    
    [_s3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(_s2);
        make.left.equalTo(_s2.mas_right).offset(space);
    }];
    
    [_s4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(_s3);
        make.left.equalTo(_s3.mas_right).offset(space);
    }];
    
    [_s5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(_s4);
        make.left.equalTo(_s4.mas_right).offset(space);
    }];
