...
typedef enum {
    COBUBBATCH = 0,          //Send Data When Start
    COBUBREALTIME = 1       //RealTime Send Policy
    //INTERVAL = 2
} MyReportPolicy;
...
+ (void)startWithAppKey:(NSString*)appKey MyReportPolicy:(MyReportPolicy)policy serverURL:(NSString*)serverURL;
/**
 *  保存错误日志
 *
 ...
 ***/
+ (NSMutableArray *) getArchivedLogs:(NSString *)appkey;
@end
